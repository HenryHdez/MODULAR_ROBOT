...
module ADC_SAR_SEQ_P4_v2_40_0 (
	...
	cy_clock_v1_0
		#(.id("6bb21b5b-28aa-4a45-8092-313e15ac24b2/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("9e4a69d0-7f24-4c4a-a78b-c65e8ed9605f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f1fd89b6-dd2e-4870-8254-948d0c14308f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("33773a34-0028-43bf-95ab-d4132cab9386"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    ADC_SAR_SEQ_P4_v2_40_0 SENSORES (
        .Vref(Net_637),
        .sdone(Net_638),
        .eoc(Net_639),
        .aclk(1'b0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b6390f18-8a32-477a-acdd-e873deb92403"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("40137d1a-a7fa-4cc7-909e-241686b8f6fe"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SENSOR_4_net;
	wire [0:0] tmpFB_0__SENSOR_4_net;
	wire [0:0] tmpIO_0__SENSOR_4_net;
	wire [0:0] tmpINTERRUPT_0__SENSOR_4_net;
	electrical [0:0] tmpSIOVREF__SENSOR_4_net;

	cy_psoc3_pins_v1_10
		#(.id("d76647a4-4ccd-4afa-a587-274159cc474e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SENSOR_4
		 (.oe(tmpOE__SENSOR_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SENSOR_4_net[0:0]}),
		  .analog({Net_547}),
		  .io({tmpIO_0__SENSOR_4_net[0:0]}),
		  .siovref(tmpSIOVREF__SENSOR_4_net),
		  .interrupt({tmpINTERRUPT_0__SENSOR_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SENSOR_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam MUX.muxin_width = 4;
    defparam MUX.init_mux_sel = 4'h0;
    defparam MUX.api_type = 1'b1;
    defparam MUX.one_active = 1;
