...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x480000ACu)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480000BCu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_MSTR0), 0x0200u);
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_CLKDIST_CR), 0x49u);
...
void AMUX_Next(void)
{
	...
	case 1:
		...
		CY_SET_REG8((void CYXDATA *)CYREG_DSM0_SW0, 0x20u);
		break;
	case 2:
