// ======================================================================
// Test_Xbee.v generated from TopDesign.cysch
// 08/11/2017 at 22:30
...
module ADC_SAR_SEQ_P4_v2_40_0 (
	...
	cy_clock_v1_0
		#(.id("997fb921-0ccc-4042-97ba-5c35f3cddd75/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__FUERZA_XBEE_net;
	wire [0:0] tmpFB_0__FUERZA_XBEE_net;
	wire [0:0] tmpIO_0__FUERZA_XBEE_net;
	wire [0:0] tmpINTERRUPT_0__FUERZA_XBEE_net;
	electrical [0:0] tmpSIOVREF__FUERZA_XBEE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		FUERZA_XBEE
		 (.oe(tmpOE__FUERZA_XBEE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__FUERZA_XBEE_net[0:0]}),
		  .analog({Net_223}),
		  .io({tmpIO_0__FUERZA_XBEE_net[0:0]}),
		  .siovref(tmpSIOVREF__FUERZA_XBEE_net),
		  .interrupt({tmpINTERRUPT_0__FUERZA_XBEE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__FUERZA_XBEE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
