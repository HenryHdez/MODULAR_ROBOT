    ...
    uint8 RX_CAN_SendMsg0(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                RX_CAN_TX_DATA_BYTE1(0)=127;
//                 RX_CAN_TX_DATA_BYTE2(0)=250;
//                 RX_CAN_TX_DATA_BYTE3(0)=2;
//                 RX_CAN_TX_DATA_BYTE4(0)=10;
//                 RX_CAN_TX_DATA_BYTE5(0)=1;
//                 RX_CAN_TX_DATA_BYTE6(0)=dato_enviado;
                /* `#END` */
...
void RX_CAN_ReceiveMsg(uint8 rxMailbox) 
{
    ...
    *******************************************************************************/
    void RX_CAN_ReceiveMsg0(void) 
    {
        /* `#START MESSAGE_0_RECEIVED` */
          dato_recibido[0]=RX_CAN_RX_DATA_BYTE(0,0);
          dato_recibido[1]=RX_CAN_RX_DATA_BYTE(0,1);
          dato_recibido[2]=RX_CAN_RX_DATA_BYTE(0,2);
          dato_recibido[3]=RX_CAN_RX_DATA_BYTE(0,3);
          dato_recibido[4]=RX_CAN_RX_DATA_BYTE(0,4);
          dato_recibido[5]=RX_CAN_RX_DATA_BYTE(0,5);
          dato_recibido[6]=RX_CAN_RX_DATA_BYTE(0,6);
          dato_recibido[7]=RX_CAN_RX_DATA_BYTE(0,7);
        /* `#END` */
    ...
    *******************************************************************************/
    void RX_CAN_ReceiveMsg3(void) 
    {
        ...
        dato_recibido1=RX_CAN_RX_DATA_BYTE1(1);
        dato_recibido2=RX_CAN_RX_DATA_BYTE1(2);
        dato_recibido3=RX_CAN_RX_DATA_BYTE1(3);
        /* `#END` */
