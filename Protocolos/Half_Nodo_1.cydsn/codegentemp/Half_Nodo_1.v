// ======================================================================
// Half_Nodo_1.v generated from TopDesign.cysch
// 09/23/2016 at 18:43
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=9600, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=0, Enable_RXIntInterrupt=0, Enable_TX=0, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=true, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=0, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=false, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=76800, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=false, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=false, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=UART_v2_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=EMITE, CY_INSTANCE_SHORT_NAME=EMITE, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=EMITE, )
module UART_v2_50_0 (
    rx_clk,
    rx_data,
    tx_clk,
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("166d237c-d31b-4473-8a45-b373f3aae799/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=9600, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=0, Enable_RXIntInterrupt=0, Enable_TX=0, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=true, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=0, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=false, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=76800, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=false, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=false, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=UART_v2_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RECIBE, CY_INSTANCE_SHORT_NAME=RECIBE, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=RECIBE, )
module UART_v2_50_2 (
    rx_clk,
    rx_data,
    tx_clk,
...
module top ;
    ...
    UART_v2_50_0 EMITE (
        ...
        .rx_data(Net_47),
        .rx_clk(Net_48));
    defparam EMITE.Address1 = 0;
    defparam EMITE.Address2 = 0;
    defparam EMITE.EnIntRXInterrupt = 0;
    defparam EMITE.EnIntTXInterrupt = 0;
    defparam EMITE.FlowControl = 0;
    defparam EMITE.HalfDuplexEn = 1;
    defparam EMITE.HwTXEnSignal = 1;
    defparam EMITE.NumDataBits = 8;
    defparam EMITE.NumStopBits = 1;
    defparam EMITE.ParityType = 0;
    defparam EMITE.RXEnable = 0;
    defparam EMITE.TXEnable = 0;
    ...
    UART_v2_50_2 RECIBE (
        ...
        .rx_data(Net_58),
        .rx_clk(Net_59));
    defparam RECIBE.Address1 = 0;
    defparam RECIBE.Address2 = 0;
    defparam RECIBE.EnIntRXInterrupt = 0;
    defparam RECIBE.EnIntTXInterrupt = 0;
    defparam RECIBE.FlowControl = 0;
    defparam RECIBE.HalfDuplexEn = 1;
    defparam RECIBE.HwTXEnSignal = 1;
    defparam RECIBE.NumDataBits = 8;
    defparam RECIBE.NumStopBits = 1;
    defparam RECIBE.ParityType = 0;
    defparam RECIBE.RXEnable = 0;
    defparam RECIBE.TXEnable = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("6f5b4490-5f53-4995-9c88-389d6afb778f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6da625a7-5e8d-4556-9f2b-b0c73c229b0d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
