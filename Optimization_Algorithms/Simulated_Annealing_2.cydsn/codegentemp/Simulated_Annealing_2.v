// ======================================================================
// Simulated_Annealing_2.v generated from TopDesign.cysch
// 01/14/2018 at 21:39
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=9600, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=1, Enable_TX=0, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=true, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=76800, RXAddressMode=0, RXBufferSize=8, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=false, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=UART_v2_50, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SENSOR_U, CY_INSTANCE_SHORT_NAME=SENSOR_U, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=SENSOR_U, )
module UART_v2_50_0 (
    cts_n,
    tx,
    rts_n,
...
module top ;
    ...
    UART_v2_50_0 SENSOR_U (
        ...
        .reset(1'b0),
        .rx(Net_596),
        .tx_interrupt(Net_597),
        .rx_interrupt(Net_598),
        .tx_data(Net_599),
        .tx_clk(Net_600),
        .rx_data(Net_601),
        .rx_clk(Net_602));
    defparam SENSOR_U.Address1 = 0;
    defparam SENSOR_U.Address2 = 0;
    defparam SENSOR_U.EnIntRXInterrupt = 1;
    defparam SENSOR_U.EnIntTXInterrupt = 0;
    defparam SENSOR_U.FlowControl = 0;
    defparam SENSOR_U.HalfDuplexEn = 0;
    defparam SENSOR_U.HwTXEnSignal = 1;
    defparam SENSOR_U.NumDataBits = 8;
    defparam SENSOR_U.NumStopBits = 1;
    defparam SENSOR_U.ParityType = 0;
    defparam SENSOR_U.RXEnable = 1;
    defparam SENSOR_U.TXEnable = 0;
