...
extern uint8 dato_enviado[8];
extern uint8 dato_enviado_1[8];
extern uint8 mailbox0[8];
    ...
    uint8 CAN_SendMsg1(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                CAN_TX_DATA_BYTE(1,0,dato_enviado_1[0]);
                CAN_TX_DATA_BYTE(1,1,dato_enviado_1[1]);
                CAN_TX_DATA_BYTE(1,2,dato_enviado_1[2]);
                CAN_TX_DATA_BYTE(1,3,dato_enviado_1[3]);
                CAN_TX_DATA_BYTE(1,4,dato_enviado_1[4]);
                CAN_TX_DATA_BYTE(1,5,dato_enviado_1[5]);
                CAN_TX_DATA_BYTE(1,6,dato_enviado_1[6]);
                CAN_TX_DATA_BYTE(1,7,dato_enviado_1[7]);
                /* `#END` */
    ...
    uint8 CAN_SendMsg4(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            else
            {
                ...
                CAN_TX_DATA_BYTE(4,0,dato_enviado_1[0]);
                CAN_TX_DATA_BYTE(4,1,dato_enviado_1[1]);
                CAN_TX_DATA_BYTE(4,2,dato_enviado_1[2]);
                CAN_TX_DATA_BYTE(4,3,dato_enviado_1[3]);
                CAN_TX_DATA_BYTE(4,4,dato_enviado_1[4]);
                CAN_TX_DATA_BYTE(4,5,dato_enviado_1[5]);
                CAN_TX_DATA_BYTE(4,6,dato_enviado_1[6]);
                CAN_TX_DATA_BYTE(4,7,dato_enviado_1[7]);
                /* `#END` */
    ...
    *******************************************************************************/
    void CAN_ReceiveMsg2(void) 
    {
        /* `#START MESSAGE_2_RECEIVED` */
            mailbox2[0]=CAN_RX_DATA_BYTE1(2);
            mailbox2[1]=CAN_RX_DATA_BYTE2(2);
            mailbox2[2]=CAN_RX_DATA_BYTE3(2);
            mailbox2[3]=CAN_RX_DATA_BYTE4(2);
            mailbox2[4]=CAN_RX_DATA_BYTE5(2);
            mailbox2[5]=CAN_RX_DATA_BYTE6(2);
            mailbox2[6]=CAN_RX_DATA_BYTE7(2);
            mailbox2[7]=CAN_RX_DATA_BYTE8(2);    
        /* `#END` */
    ...
    *******************************************************************************/
    void CAN_ReceiveMsg3(void) 
    {
        /* `#START MESSAGE_3_RECEIVED` */
            mailbox3[0]=CAN_RX_DATA_BYTE1(3);
            mailbox3[1]=CAN_RX_DATA_BYTE2(3);
            mailbox3[2]=CAN_RX_DATA_BYTE3(3);
            mailbox3[3]=CAN_RX_DATA_BYTE4(3);
            mailbox3[4]=CAN_RX_DATA_BYTE5(3);
            mailbox3[5]=CAN_RX_DATA_BYTE6(3);
            mailbox3[6]=CAN_RX_DATA_BYTE7(3);
            mailbox3[7]=CAN_RX_DATA_BYTE8(3);   
        /* `#END` */
